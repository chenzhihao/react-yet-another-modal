...
export default class Portal extends React.Component {
  ...
  componentWillReceiveProps (newProps) {
    // if it's already unmounted, we should set active to false;
    if (this.unmounted) {
    ...
    if (typeof newProps.isOpened === 'undefined' && this.state.active && !this.unmounted) {
      this.renderPortal(newProps);
    }
  }
  ...
  closePortal (isUnmounted = false) {
    const resetPortalState = () => {
      if (this.node) {
        ...
        // Add a flag to avoid ReactUpdates.batchedUpdates(unmountComponentFromNode, prevComponent, container, false) issue.
        // Otherwise even the ReactDOM.unmountComponentAtNode is called, the componentWillReceiveProps method will still be triggered.
        this.unmounted = true;
      }
      this.portal = null;
      this.node = null;
